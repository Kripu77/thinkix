...
export const ConversationScrollButton = ({
  ...
  return (
    <Button
      className={cn(
        'absolute bottom-4 left-[50%] -translate-x-1/2 rounded-full bg-background shadow-sm hover:bg-muted',
        className,
      )}
...
export const ConversationDownload = ({
  ...
  return (
    <Button
      className={cn(
        'absolute right-4 top-4 rounded-full bg-background shadow-sm hover:bg-muted',
        className,
      )}
