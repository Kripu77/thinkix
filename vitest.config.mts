...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'packages/ai/**/*.test.{ts,tsx}',
      'packages/plait-utils/**/*.test.{ts,tsx}',
      'packages/storage/**/*.test.{ts,tsx}',
      'packages/shared/**/*.test.{ts,tsx}',
      'packages/file-utils/**/*.test.{ts,tsx}',
      'packages/mermaid-to-thinkix/**/*.test.{ts,tsx}',
      'packages/collaboration/**/*.test.{ts,tsx}',
    ],
    exclude: [
      'node_modules/**',
      'scratch/**',
